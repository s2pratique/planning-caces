    ...
    <div className="flex flex-col items-center justify-center min-h-screen p-8">
      <div className="max-w-2xl w-full space-y-8">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8 space-y-6">
          ...
          <div className="space-y-4">
            ...
            <StatusItem 
              status="✅" 
              title="Backend" 
              description="Déployé sur Railway"
            />
            <StatusItem 
              status="🚧" 
              title="Frontend" 
            ...
            <StatusItem 
              ...
              description="PostgreSQL configurée"
            />
            <StatusItem 
              status="⏳" 
        ...
        <div className="bg-green-50 dark:bg-green-900/30 border border-green-200 dark:border-green-800 rounded-lg p-6">
          <h3 className="text-lg font-semibold mb-2">🔗 URLs de l'infrastructure</h3>
          <div className="space-y-2 text-sm">
            <div>
              <span className="font-medium">Backend API:</span>{' '}
              <a 
                href="https://planning-caces-production.up.railway.app/health" 
                target="_blank" 
                rel="noopener noreferrer"
                className="text-blue-600 dark:text-blue-400 hover:underline"
              >
                planning-caces-production.up.railway.app
              </a>
            </div>
            <div>
